...
*/ -}}
{{- define "eric-oss-common-ci-utils.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-oss-common-ci-utils.mergeAnnotations" -}}
  {{- include "eric-oss-common-ci-utils.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}
{{- define "eric-oss-common-ci-utils.mergeLabels" -}}
  {{- include "eric-oss-common-ci-utils.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
